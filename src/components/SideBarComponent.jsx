    ...
    <div class="left-nav">
      ...
      <ul class="nav-pages py-2">
        ...
        <li class="d-flex align-items-center your-library px-3">
          ...
          <span class="nav-page-text px-2">Your library</span>
        </li>
      </ul>
      <ul class="nav-extra py-2">
        <li class="d-flex align-items-center create-playlist px-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          ...
          <span class="nav-page-text px-2">Create Playlist</span>
        </li>

        <li class="d-flex align-items-center liked-songs px-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          ...
          <span class="nav-page-text px-2">Liked Songs</span>
        </li>
      </ul>
